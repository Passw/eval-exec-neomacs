...
use crate::elisp::display::{expect_frame_designator, live_frame_designator_p};
use crate::elisp::error::{signal, EvalResult, Flow};
use crate::elisp::terminal::pure::{expect_terminal_designator, expect_terminal_designator_eval};
...
fn live_window_designator_p(eval: &mut crate::elisp::eval::Evaluator, value: &Value) -> bool {
    match value {
...
fn expect_window_designator_eval(
    eval: &mut crate::elisp::eval::Evaluator,
    value: &Value,
) -> Result<(), Flow> {
...
fn selected_window_id(eval: &mut crate::elisp::eval::Evaluator) -> Option<WindowId> {
