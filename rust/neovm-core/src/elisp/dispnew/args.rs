...
pub(super) fn expect_args_range(
    name: &str,
    args: &[Value],
    min: usize,
    max: usize,
...
// ---------------------------------------------------------------------------
// Helper: extract a number of seconds as f64 from an int or float Value
// ---------------------------------------------------------------------------

pub(super) fn extract_seconds(value: &Value) -> Result<f64, Flow> {
    match value {
