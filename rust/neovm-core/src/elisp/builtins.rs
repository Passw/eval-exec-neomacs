...
pub(crate) fn dispatch_builtin(
    ...
    Some(match name {
        ...
        "commandp" => super::builtins_extra::builtin_commandp(args),
        ...
        "default-value" => super::builtins_extra::builtin_default_value(args),
        "set-default" => super::builtins_extra::builtin_set_default(args),
        "local-variable-p" => super::builtins_extra::builtin_local_variable_p(args),
        "make-local-variable" => super::builtins_extra::builtin_make_local_variable(args),
        "kill-local-variable" => super::builtins_extra::builtin_kill_local_variable(args),
