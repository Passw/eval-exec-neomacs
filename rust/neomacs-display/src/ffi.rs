...
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_focus_mode(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    opacity: c_int,
) {
...
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_mode_line_transition(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    duration_ms: c_int,
) {
...
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_crosshair(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int,
    g: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_scroll_velocity_fade(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    max_opacity: c_int,
    fade_ms: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_minibuffer_highlight(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int,
    g: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_wrap_indicator(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int,
    g: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_topo_contour(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    spacing: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_metronome(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    tick_height: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_constellation(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    star_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_radar(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    radius: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_hex_grid(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    cell_size: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_sparkle_burst(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    particle_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_circuit_trace(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    trace_width: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_compass(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    size: c_int,
