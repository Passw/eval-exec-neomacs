...
allowlist_file="${1:-$script_dir/cases/builtin-registry-autoload-metadata-allowlist.txt}"
...
echo "checked core autoload-metadata parity entries: $core_total"
echo "skipped extension entries: $extension_total"
echo "oracle/neovm autoload-metadata drifts: $drift"
...
echo "builtin registry autoload-metadata parity check passed"
