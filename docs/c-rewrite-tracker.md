...
Last updated: 2026-02-25 (97/98 rust-default; only profiler.c remains partial)
...
| `src/atimer.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 1 DEFUN dispatched (debug-timer-check) |
...
| `src/bytecode.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 2 DEFUNs dispatched |
...
| `src/cmds.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 7 DEFUNs dispatched |
...
| `src/dbusbind.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs`, `rust/neovm-core/src/elisp/dbus.rs` | - | - | - | All 6 DEFUNs dispatched (3 in dbus.rs, 3 inhibitor-lock stubs in builtins.rs) |
| `src/decompress.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 2 DEFUNs dispatched |
...
| `src/emacs-module.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 1 DEFUN dispatched (module-function-p) |
| `src/emacs.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 5 DEFUNs dispatched |
...
| `src/filelock.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 5 DEFUNs dispatched |
...
| `src/fontset.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 4 DEFUNs dispatched (fontset-list-all gap filled) |
...
| `src/fringe.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 4 DEFUNs dispatched |
...
| `src/gnutls.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 19 DEFUNs dispatched |
...
| `src/inotify.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 5 DEFUNs dispatched (inotify-watch-list, inotify-allocated-p gap filled) |
...
| `src/lcms.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 8 DEFUNs dispatched (stubs; no lcms in NeoVM) |
...
| `src/macros.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 6 DEFUNs dispatched |
...
| `src/menu.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 3 DEFUNs dispatched |
...
| `src/neomacsfns.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All DEFUNs dispatched (12 gap-fill stubs for frame/mouse/clipboard/monitor) |
| `src/neomacsterm.c` | `rust-default` | `rust/neomacs-display/` | - | - | - | 220 DEFUNs; C FFI bridge to Rust render thread via neomacs-display crate |
| `src/pdumper.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 4 DEFUNs dispatched |
...
| `src/sound.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 1 DEFUN dispatched |
| `src/sqlite.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 17 DEFUNs dispatched |
...
| `src/sysdep.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All 1 DEFUN dispatched |
| `src/systhread.c` | `rust-default` | `-` | - | - | - | 0 DEFUNs; internal C infrastructure |
| `src/term.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs`, `rust/neovm-core/src/elisp/terminal/pure.rs` | - | - | - | All DEFUNs dispatched (7 tty-frame/display stubs gap filled) |
| `src/terminal.c` | `rust-default` | `rust/neovm-core/src/elisp/terminal/pure.rs` | - | - | - | All 8 DEFUNs dispatched |
...
| `src/treesit.c` | `rust-default` | `rust/neovm-core/src/elisp/builtins.rs` | - | - | - | All DEFUNs dispatched (12 gap-fill stubs for grammar/linecol/embed/parse-string) |
