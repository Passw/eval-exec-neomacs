...
NEOMACS_CONFIGURE_FLAGS="${NEOMACS_CONFIGURE_FLAGS:---without-ns --with-file-notification=no --with-native-compilation=no --with-neomacs --with-neovm-core-backend=emacs-c}"
