...
{
  /* No-op: Neomacs images use sentinel pixmap (1) and GPU-backed
     rendering.  The conversion/mask algorithms operated on C pixmaps
...
NEOMACS_TYPE_VALIDATOR(pbm, Qpbm)
NEOMACS_TYPE_VALIDATOR(xbm, Qxbm)
...
static struct image_type const image_types[] =
{
 ...
 { SYMBOL_INDEX (Qxbm), neomacs_xbm_image_p, neomacs_load, neomacs_clear_image },
 { SYMBOL_INDEX (Qpbm), neomacs_pbm_image_p, neomacs_load, neomacs_clear_image },
};
